...
const Report = () => {
  ...
  const handleStatus=(e)=>{
      var p = document.getElementById(e.target.id)
      console.log(p.value)
  }
  return (
    <div className='flex'>
      <LeftsideBar/>
      <div className={`relative p-7 w-full lg:w-5/6 `}>
        <table className= {`min-w-max w-full table-auto`}>
  
            <thead>
              <tr className="bg-green-200 text-gray-600 uppercase text-sm leading-normal">
                <th className="py-3 px-6 text-left cursor-pointer" >No.</th>
                <th className="py-3 px-6 text-left">User Name</th>
                <th className="py-3 px-6 text-center">Area</th>
         ...
         className="border-b border-gray-200 hover:bg-gray-100">
             ...
             <div className="flex items-center">
              ...
              <td className="py-3 px-6 text-center">
                ...
                <div><strong>6 sep 2023</strong></div>
                </div>
              </td>
              <td className="py-3 px-6 text-center">
             ...
             <select 
                ...
                className={`rounded-xl font-semibold text-gray-600 `}>
                <option  value="pending" className=' bg-lime-100'>Pending</option>
                <option value="viewed" className=' bg-lime-100'>viewed</option>
                <option value="resolved" className=' bg-lime-100'>resolved</option>
               </select>
