...
const BlogDetails = () => {
  return (
    ...
    <div className=' m-8 p-2'>
     <h1 className=' text-center font-extrabold text-3xl'>Bill will give mobility to subaltern women but will it change culture?</h1>
     <div className=' md:mt-12'>
        <div className=' border md:w-full  lg:w-[12rem] lg:shadow-xl md:h-[8rem] lg:h-[13rem]  border-gray-500'>
        <div className=' md:flex lg:flex-col'>
            ...
            />
            <h1 className=' ml-8 text-base font-bold  lg:mt-0 md:mt-5'>Badri Narayan</h1>
            </div>
            <h2 className=' text-gray-500 text-sm p-1'>Badri Narayan is professor at the Govind Ballabh Pant Social Science Institute, Allahabad.</h2>
        </div>
...
As various electoral results show,  the BJP led by PM Narendra Modi has been able to attract a large percentage of women voters. The Women’s Reservation Bill, which ensures 33% reservation in parliamentary and assembly seats, is going to enhance and consolidate this support. It may bring a large number of new women voters and add substantially to the BJP’s female cadre. It may give PM Modi long-lasting political capital among women, across caste and religion. The timing of the Bill is bound to impact the 2024 election and forthcoming state elections.</p>
      ...
      />
      <h2  className=' mb-6 text-center text-gray-500'>image description</h2>
      <p className=' text-center text-base'>We will see two kinds of contesting narratives around it in the coming months. One is the BJP narrative, which will assert that it fulfilled the dream of women’s reservation, and the other is the Congress narrative, which claims that it initiated this discourse in Parliament.
...
We are going to see a whole new face of Indian democracy in the coming years.</p>

  <h2 className=' text-gray-400 text-center mt-5'>-------END OF ARTICLE--------</h2>
