...
const Cart = ({play,setplay,img}) => {
  ...
  return (
    ...
    <div className=" bg-green-500 mt-10 w-80 z-0 ml-10 mb-10 h-80    rounded-xl ">
      ...
      <div className=" basis-1/2 text-center border text-white border-black rounded-bl-lg p-0.5 bg-green-900 font-semibold hover:bg-slate-300 ">Edit</div>
        <div className=" basis-1/2 text-center border text-white border-black rounded-br-lg bg-red-400 font-semibold hover:bg-slate-300">Delete</div>
      </div>
