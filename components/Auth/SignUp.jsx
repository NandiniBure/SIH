      ...
      <div className="text-white">
        <div className="mb-8 flex flex-col items-center">
          <img
            ...
            srcSet=""
          />
          <h1 className="mb-2 text-2xl text-orange-400 font-bold">Kerala Governament</h1>
        ...
        <form action="#">
          ...
          <div className="mb-4 text-lg">
            <input
              className="rounded-3xl hover:border-white border-none bg-green-400 bg-opacity-50 px-6 py-2 text-center text-inherit placeholder-slate-200 shadow-lg outline-none backdrop-blur-md"
